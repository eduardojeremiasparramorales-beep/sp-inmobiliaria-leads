...
const REQUIRED_VARS = {
    ...
    VERIFY_TOKEN: {
        pattern: /^.{20,}$/,
        minLength: 20,
        description: 'Token para verificar webhook (mínimo 20 caracteres)',
    },
    API_TOKEN: {
        pattern: /^.{20,}$/,
        minLength: 20,
        description: 'Token para proteger endpoints (mínimo 20 caracteres)',
    },
};
...
async function main() {
    ...
    if (allValid && metaOk) {
        ...
        log.info('3. Sigue CONFIGURATION.md para desplegar en Railway');
        process.exit(0);
